...
function hero() {
  ...
  <div className="mx-auto max-w-7xl">
    ...
    <div className="mt-6 flex items-center justify-center gap-4">
      <a href="#" className=" rounded-md bg-indigo-600/95 px-5 py-3 font-medium text-white transition-colors hover:bg-indigo-700">Get started for free</a>
      <a href="#" className=" rounded-md border border-slate-200 px-5 py-3 font-medium text-slate-900 transition-colors hover:bg-slate-50"> Request a demo </a>
    </div>
  </div>
</section>
  )
